...
function Dlcard8({ addToCart }) {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col><img src={card8} alt="image1" className='page3dcardcol1' />
        ...
        <Row className='mt-3 '>
            <Col className='imgandnamecard' ><img src={pimg8} alt="img" /><br />
            <div>
            <span className='b mt-5 fwb'> Roman </span><br />
