...
function Dlcard5({ addToCart }) {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col><img src={card5} alt="image1" className='page3dcardcol1' />
        ...
        <Row className='mt-3 '>
            <Col className='imgandnamecard' ><img src={pimg5} alt="img" /><br />
            <div>
            <span className='b mt-5 fwb'> Jhon Jio </span><br />
