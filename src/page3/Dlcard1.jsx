...
function Dlcard1({ addToCart }) {
  ...
  return (
    <div className='padtop120px'>
         <Container>
      <Row>
        <Col><img src={card1} alt="image1" className='page3dcardcol1' />
        ...
        <span>(16325)</span>  <span className='o fs-3 fwb'> &nbsp; &#8377; 999 </span> </p>

        <Row className='mt-3 '>
            <Col className='imgandnamecard' ><img src={pimg1} alt="img" /><br />
            <div>
            <span className='b mt-5 fwb'> Jane Cooper </span><br />
